<template>
  ...
  <div class="modal fade" id="update_personal_skills" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">{{ words.update_skills_data }}</h5>
          ...
          <form>
            <div class="form-group position-relative input-icon flex-wrap mb-2">
              <label class="d-flex align-items-center">
                <span class="mrl-half">{{ words.skill_name }}</span>
                <span class="red">*</span>
              </label>
            ...
            <div class="form-group position-relative input-icon flex-wrap mb-2">
              <label class="d-flex align-items-center">
                <span class="mrl-half">{{ words.sub_skill_name }}</span>
            ...
            <div class="col-12 mb-2">
              <div class="form-group position-relative input-icon flex-wrap">
                ...
                <select class="form-control" name="country_id">
                  ...
                  <option value="1" v-for="i in 4">good</option>
                </select>
              </div>
            </div>
            <div class="form-group position-relative input-icon flex-wrap mb-2">
...
export default {
  name: "update_personal_skills",
  data(){
    return {
      file_name:'modals/update_personal_skills',
    }
  },
  mixins:[WordsLang],
}
